...
r"/home/tq877/Tianyu/player_selection/MCP/data_ped/original_trajectories_1.json",
r"/home/tq877/Tianyu/player_selection/MCP/data_ped/trajectories_[1]_[All]_[1].json",
r"/home/tq877/Tianyu/player_selection/MCP/data_ped/trajectories_[1]_[Neural Network Threshold]_[0.5].json",
]
...
time_labels = [
    #r"$t=1\,\mathrm{s}$", # uncomment for 5 col labels
    r"$t=3\,\mathrm{s}$",
    r"$t=5\,\mathrm{s}$",
    r"$t=7\,\mathrm{s}$",
    r"$t=9\,\mathrm{s}$",
...
for row, method_file in enumerate(methods):
    ...
    step_indices = [30, 50, 70, 90]  # specific time steps to plot
